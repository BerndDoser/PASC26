...
![](images/illustris_latent_sphere_quarter.png){.absolute top=-120 right=-100 width="500" height="500"}
...
- **Our approach:** modular open-source tools for unbiased, self-supervised knowledge discovery\
  [PEST](https://github.com/HITS-AIN/PEST) → [Spherinator](https://github.com/HITS-AIN/Spherinator) → [HiPSter](https://github.com/HITS-AIN/HiPSter) → DynaVerse SUE
