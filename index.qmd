...
- The **Elbow Method** is a heuristic used to determine the optimal number of dimensions in a latent space by analyzing the explained variance or reconstruction error as a function of the number of dimensions.
...
sns.set_theme()
fig, ax = plt.subplots()
sns.lineplot(data=df, x="sdim", y="l1loss_val_min", marker="o", ax=ax, label="validation")
sns.lineplot(data=df, x="sdim", y="l1loss_train_min", marker="o", ax=ax, label="training")
